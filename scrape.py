...
def main(args):
	...
	parser.add_argument('-s', '--search', default='ambulance', type=str, help='search term')
	parser.add_argument('-n', '--num_images', default=100, type=int, help='num images to save')
	parser.add_argument('-d', '--directory', default='/home/anand/scrapeImb', type=str, help='save directory')
